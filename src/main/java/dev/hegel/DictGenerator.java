 ...
 * map.
 */
final class DictGenerator<K, V> implements Generator<Map<K, V>>, MaybeBasic<Map<K, V>> {
  private final Generator<K> keys;
  private final Generator<V> values;
  private final long minSize;
  private final long maxSize;

  DictGenerator(Generator<K> keys, Generator<V> values, long minSize, long maxSize) {
