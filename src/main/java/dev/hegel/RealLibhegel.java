...
final class RealLibhegel implements Libhegel {
    ...
    RealLibhegel(Path libraryPath) {
        ...
        this.settingsFree = h(linker, lookup, "hegel_settings_free", FunctionDescriptor.ofVoid(ADDRESS));
        this.settingsMode = h(linker, lookup, "hegel_settings_mode", FunctionDescriptor.ofVoid(ADDRESS, JAVA_INT));
        this.settingsTestCases =
                h(linker, lookup, "hegel_settings_test_cases", FunctionDescriptor.ofVoid(ADDRESS, JAVA_LONG));
        this.settingsVerbosity =
                h(linker, lookup, "hegel_settings_verbosity", FunctionDescriptor.ofVoid(ADDRESS, JAVA_INT));
        this.settingsSeed =
                h(linker, lookup, "hegel_settings_seed", FunctionDescriptor.ofVoid(ADDRESS, JAVA_LONG, JAVA_BOOLEAN));
        this.settingsDerandomize =
                h(linker, lookup, "hegel_settings_derandomize", FunctionDescriptor.ofVoid(ADDRESS, JAVA_BOOLEAN));
        this.settingsReportMultipleFailures = h(
                linker,
                lookup,
        ...
        this.settingsDatabaseKey =
                h(linker, lookup, "hegel_settings_database_key", FunctionDescriptor.ofVoid(ADDRESS, ADDRESS));
        this.settingsPhases = h(linker, lookup, "hegel_settings_phases", FunctionDescriptor.ofVoid(ADDRESS, JAVA_INT));
        this.settingsSuppressHealthCheck =
                h(linker, lookup, "hegel_settings_suppress_health_check", FunctionDescriptor.ofVoid(ADDRESS, JAVA_INT));
        this.runStart = h(linker, lookup, "hegel_run_start", FunctionDescriptor.of(ADDRESS, ADDRESS));
        this.nextTestCase = h(linker, lookup, "hegel_next_test_case", FunctionDescriptor.of(ADDRESS, ADDRESS));
        ...
        this.startSpan = h(linker, lookup, "hegel_start_span", FunctionDescriptor.of(JAVA_INT, ADDRESS, JAVA_LONG));
        this.stopSpan = h(linker, lookup, "hegel_stop_span", FunctionDescriptor.of(JAVA_INT, ADDRESS, JAVA_BOOLEAN));
        ...
        this.collectionMore = h(
                linker, lookup, "hegel_collection_more", FunctionDescriptor.of(JAVA_INT, ADDRESS, JAVA_LONG, ADDRESS));
        this.collectionReject = h(
                linker,
                lookup,
                "hegel_collection_reject",
                FunctionDescriptor.of(JAVA_INT, ADDRESS, JAVA_LONG, ADDRESS));
        this.target = h(linker, lookup, "hegel_target", FunctionDescriptor.of(JAVA_INT, ADDRESS, JAVA_DOUBLE, ADDRESS));
        this.markComplete =
                h(linker, lookup, "hegel_mark_complete", FunctionDescriptor.of(JAVA_INT, ADDRESS, JAVA_INT, ADDRESS));
        this.isFinalReplay =
                h(linker, lookup, "hegel_test_case_is_final_replay", FunctionDescriptor.of(JAVA_BOOLEAN, ADDRESS));
        this.resultPassed = h(linker, lookup, "hegel_run_result_passed", FunctionDescriptor.of(JAVA_BOOLEAN, ADDRESS));
        this.resultFailureCount =
                h(linker, lookup, "hegel_run_result_failure_count", FunctionDescriptor.of(JAVA_LONG, ADDRESS));
        this.resultFailure =
                h(linker, lookup, "hegel_run_result_failure", FunctionDescriptor.of(ADDRESS, ADDRESS, JAVA_LONG));
        this.failurePanicMessage =
                h(linker, lookup, "hegel_failure_panic_message", FunctionDescriptor.of(ADDRESS, ADDRESS));
        this.failureDiagnostic = h(linker, lookup, "hegel_failure_diagnostic", FunctionDescriptor.of(ADDRESS, ADDRESS));
        this.failureOrigin = h(linker, lookup, "hegel_failure_origin", FunctionDescriptor.of(ADDRESS, ADDRESS));
        this.lastErrorMessage = h(linker, lookup, "hegel_last_error_message", FunctionDescriptor.of(ADDRESS));
