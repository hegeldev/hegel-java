 ...
 */
public final class ZoneOffsetGenerator implements Generator<ZoneOffset>, MaybeBasic<ZoneOffset> {
  private final int minSeconds;
  private final int maxSeconds;

  ZoneOffsetGenerator(int minSeconds, int maxSeconds) {
    if (minSeconds > maxSeconds) {
      throw new IllegalArgumentException(
          "zoneOffsets: min (" + minSeconds + "s) > max (" + maxSeconds + "s)");
    }
  ...
  @Override
  public ZoneOffset generate(TestCase tc) {
